export const milestoneAbiTest = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint256", name: "maxMilestones", type: "uint256" }],
    name: "MaxMilestonesSet",
    type: "event",
  },
  {
    anonymous: false,
  ...
  {
    inputs: [{ internalType: "uint256", name: "_maxMilestones", type: "uint256" }],
    name: "setMaxMilestones",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
